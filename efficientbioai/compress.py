...
def main():
    ...
    parser.add_argument('--cfg_path', type=str, default='configs/omnipose/omnipose.yaml', help='config path.')
    parser.add_argument('--exp_path', type=str, default="experiment/test_cp_opv_fp32", help='experiment path.')
