...
parser.add_argument('--config', type=str, default="experiment/labelfree_opv_int8/mmv_im2im.yaml", help='path to the config file.')
...
#for mmv_im2im:
# inference.run_infer()
# inference.evaluate('./data/mmv_im2im/labelfree/pred','./data/mmv_im2im/labelfree/holdout','.tif','_GT.tiff',['SSIM','Pearson']) #currently only for mmv_im2im
